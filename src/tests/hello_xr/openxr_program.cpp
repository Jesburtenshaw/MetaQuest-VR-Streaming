    ...
    struct OpenXrProgram : IOpenXrProgram {
        ...
        static void LogLayersAndExtensions() {
            ...
            const auto logExtensions = [](const char *layerName, int indent = 0) {
                ...
                CHECK_XRCMD(xrEnumerateInstanceExtensionProperties(layerName, 0,
        ...
        void LogInstanceInfo() {
            ...
            Log::Write(Log::Level::Info, Fmt("Instance RuntimeName=%s RuntimeVersion=%s",
                                             instanceProperties.runtimeName,
                                             GetXrVersionString(
                                                     instanceProperties.runtimeVersion).c_str()));
        }
        ...
        void CreateInstanceInternal() {
            ...
            createInfo.applicationInfo.apiVersion =
                    XR_MAKE_VERSION(XR_VERSION_MAJOR(XR_CURRENT_API_VERSION), 0,
        ...
        void LogViewConfigurations() {
            ...
            CHECK_XRCMD(
                    xrEnumerateViewConfigurations(m_instance, m_systemId, 0, &viewConfigTypeCount,
                                                  nullptr));
            ...
            Log::Write(Log::Level::Info,
                       Fmt("Available View Configuration Types: (%d)", viewConfigTypeCount));
            for (XrViewConfigurationType viewConfigType: viewConfigTypes) {
                ...
                uint32_t viewCount;
                CHECK_XRCMD(
                        xrEnumerateViewConfigurationViews(m_instance, m_systemId, viewConfigType, 0,
                                                          &viewCount, nullptr));
                if (viewCount > 0) {
        ...
        void LogEnvironmentBlendMode(XrViewConfigurationType type) {
            ...
            CHECK_XRCMD(
                    xrEnumerateEnvironmentBlendModes(m_instance, m_systemId, type, count, &count,
                                                     blendModes.data()));
        ...
        XrEnvironmentBlendMode GetPreferredBlendMode() const override {
            ...
            std::vector<XrEnvironmentBlendMode> blendModes(count);
            CHECK_XRCMD(xrEnumerateEnvironmentBlendModes(m_instance, m_systemId,
                                                         m_options->Parsed.ViewConfigType, count,
                                                         &count,
                                                         blendModes.data()));
        ...
        void InitializeActions() {
            ...
            // Suggest bindings for KHR Simple.
            {
                ...
                CHECK_XRCMD(
                        xrStringToPath(m_instance, "/interaction_profiles/khr/simple_controller",
            ...
            // Suggest bindings for the Oculus Touch.
            {
                ...
                CHECK_XRCMD(
                        xrStringToPath(m_instance, "/interaction_profiles/oculus/touch_controller",
            ...
            // Suggest bindings for the Vive Controller.
            {
                ...
                CHECK_XRCMD(
                        xrStringToPath(m_instance, "/interaction_profiles/htc/vive_controller",
            ...
            // Suggest bindings for the Valve Index Controller.
            {
                ...
                CHECK_XRCMD(
                        xrStringToPath(m_instance, "/interaction_profiles/valve/index_controller",
        ...
        void CreateSwapchains() override {
            ...
            Log::Write(Log::Level::Info,
                       Fmt("System Properties: Name=%s VendorId=%d", systemProperties.systemName,
            ...
            if (viewCount > 0) {
                ...
                CHECK_XRCMD(
                        xrEnumerateSwapchainFormats(m_session, (uint32_t) swapchainFormats.size(),
                                                    &swapchainFormatCount,
                                                    swapchainFormats.data()));
                CHECK(swapchainFormatCount == swapchainFormats.size());
                m_colorSwapchainFormat = m_graphicsPlugin->SelectColorSwapchainFormat(
                        swapchainFormats);
        ...
        void HandleSessionStateChangedEvent(const XrEventDataSessionStateChanged &stateChangedEvent,
            ...
            Log::Write(Log::Level::Info,
                       Fmt("XrEventDataSessionStateChanged: state %s->%s session=%lld time=%lld",
                           to_string(oldState),
                           to_string(m_sessionState), stateChangedEvent.session,
        ...
        void LogActionSourceName(XrAction action, const std::string &actionName) const {
            ...
            CHECK_XRCMD(
                    xrEnumerateBoundSourcesForAction(m_session, &getInfo, uint32_t(paths.size()),
